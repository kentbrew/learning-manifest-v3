...
Purely by accident I had a Web inspector set to the Application tab up on the V2 baseline background page when I dragged in the V3 test version, and saw a service worker install itself.
